#include "pr_3dof_storage/single_recorder.hpp"
#include <chrono>
#include <memory>
#include <utility>
#include <array>
...
{
    /**** 3DOF SINGLE RECORDER COMPONENT ****/
    ...
    : Node("single_recorder", options)
    {
        ...
        subscription_ = this->create_subscription<pr_3dof_msgs::msg::PRArrayH>(
            "/sub",
                10,
    ...
    void SingleRecorder::topic_callback(const pr_3dof_msgs::msg::PRArrayH::SharedPtr data_msg)
    {
...
RCLCPP_COMPONENTS_REGISTER_NODE(pr_3dof_storage::SingleRecorder)